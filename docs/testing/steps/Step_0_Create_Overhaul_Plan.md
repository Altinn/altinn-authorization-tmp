...
- Output: [`docs/testing/TESTING_INFRASTRUCTURE_OVERHAUL.md`](../TESTING_INFRASTRUCTURE_OVERHAUL.md)
...
See: [TESTING_INFRASTRUCTURE_OVERHAUL.md — Phase 1](../TESTING_INFRASTRUCTURE_OVERHAUL.md#phase-1-foundation--unify-xunit-version--target-framework)
