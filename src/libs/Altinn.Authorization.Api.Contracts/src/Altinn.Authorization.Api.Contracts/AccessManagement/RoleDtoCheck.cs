...
/// <summary>
/// Role delegation check response model
/// </summary>
public class RoleDtoCheck
{
    /// <summary>
    /// Role the delegation check is regarding
    /// </summary>
    ...
    public class Reason
    {
        ...
        /// <summary>
        /// Role ID of the originating assignment
        /// </summary>
        public Guid? RoleId { get; set; }

        /// <summary>
        /// Role URN of the originating assignment
        /// </summary>
