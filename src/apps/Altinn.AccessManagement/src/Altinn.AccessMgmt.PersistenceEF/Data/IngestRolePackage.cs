...
public static partial class StaticDataIngest
{
    ...
    public async static Task IngestRolePackage(AppDbContext dbContext, CancellationToken cancellationToken = default)
    {
        ...
        var data = new List<RolePackage>()
        {
            ...
            new RolePackage() {RoleId = RoleConstants.TheEnforcementOfficerEnforcement, PackageId = PackageConstants.VergemalTheEnforcementOfficerEnforcement.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            ...
            new RolePackage() {RoleId = RoleConstants.TheTaxAdministrationCollection, PackageId = PackageConstants.VergemalTheTaxAdministrationCollection.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
            ...
            new RolePackage() {RoleId = RoleConstants.TheNorwegianNationalCollectionAgencyDebtSettlementAndPaymentAgreements, PackageId = PackageConstants.VergemalTheNorwegianNationalCollectionAgencyDebtSettlementAndPaymentAgreements.Id, EntityVariantId = null, CanDelegate = false, HasAccess = true },
