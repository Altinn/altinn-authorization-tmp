...
namespace Altinn.AccessMgmt.PersistenceEF.Migrations
{
    ...
    [Migration("20260701160036_ConsentModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Altinn.AccessMgmt.PersistenceEF.Models.Consent.ConsentContext", b =>
                {
                    ...
                    b.ToTable("context", "consent");
                });

            modelBuilder.Entity("Altinn.AccessMgmt.PersistenceEF.Models.Consent.ConsentEvent", b =>
                {
                    b.Property<Guid>("ConsentEventId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasColumnName("consenteventid");
                    ...
                    b.Property<Guid>("PerformedByParty")
                        .HasColumnType("uuid")
                        .HasColumnName("performedbyparty");

                    b.HasKey("ConsentEventId")
                        .HasName("pk_consentevent");

                    b.ToTable("consentevent", "consent");
                });

            modelBuilder.Entity("Altinn.AccessMgmt.PersistenceEF.Models.Consent.ConsentMetadata", b =>
                {
                    b.Property<Guid>("ConsentRightId")
                        .HasColumnType("uuid")
                        .HasColumnName("consentrightid");
            ...
            modelBuilder.Entity("Altinn.AccessMgmt.PersistenceEF.Models.Consent.ConsentRequest", b =>
                {
                    b.Property<Guid>("ConsentRequestId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<DateTimeOffset?>("Consented")
                        .HasColumnType("timestamp with time zone")
                    ...
                    b.Property<Guid?>("FromPartyUuid")
                        .HasColumnType("uuid")
                        .HasColumnName("frompartyuuid");

                    b.Property<Guid?>("HandledByPartyUuid")
                        .HasColumnType("uuid")
                    ...
                    b.Property<Dictionary<string, string>>("RequestMessage")
                        .HasColumnType("hstore")
                        .HasColumnName("requestmessage");

                    b.Property<Guid?>("RequiredDelegatorUuid")
                        .HasColumnType("uuid")
                        .HasColumnName("requireddelegatoruuid");
                    ...
                    b.Property<Guid?>("ToPartyUuid")
                        .HasColumnType("uuid")
                        .HasColumnName("topartyuuid");

                    b.Property<DateTimeOffset>("ValidTo")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("validto");

                    b.HasKey("ConsentRequestId")
                        .HasName("pk_consentrequest");

                    b.ToTable("consentrequest", "consent");
                });

            modelBuilder.Entity("Altinn.AccessMgmt.PersistenceEF.Models.Consent.ConsentResourceAttribute", b =>
                {
                    b.Property<Guid>("ConsentRightId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("ConsentRightId")
                        .HasName("pk_resourceattribute");

                    b.ToTable("resourceattribute", "consent");
                });

            modelBuilder.Entity("Altinn.AccessMgmt.PersistenceEF.Models.Consent.ConsentRight", b =>
                {
                    b.Property<Guid>("ConsentRightId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.PrimitiveCollection<string[]>("Action")
                        .HasColumnType("text[]")
                        .HasColumnName("action");
                    ...
                    b.HasKey("ConsentRightId")
                        .HasName("pk_consentright");

                    b.ToTable("consentright", "consent");
                });
