...
namespace Altinn.AccessMgmt.PersistenceEF.Migrations
{
    ...
    [Migration("20260215013253_RequestAssignmentModels")]
            ...
            modelBuilder.Entity("Altinn.AccessMgmt.PersistenceEF.Models.RequestAssignment", b =>
                {
                    ...
                    b.HasIndex("RequestedById")
                        .HasDatabaseName("ix_requestassignment_requestedbyid");
                    ...
                    b.HasIndex("FromId", "ToId", "RoleId", "RequestedById", "Status")
                        .IsUnique()
                        .HasDatabaseName("ix_requestassignment_fromid_toid_roleid_requestedbyid_status");
            ...
            modelBuilder.Entity("Altinn.AccessMgmt.PersistenceEF.Models.RequestAssignmentPackage", b =>
                {
                    ...
                    b.HasIndex("RequestedById")
                        .HasDatabaseName("ix_requestassignmentpackage_requestedbyid");

                    b.HasIndex("AssignmentId", "PackageId", "RequestedById", "Status")
                        .IsUnique()
                        .HasDatabaseName("ix_requestassignmentpackage_assignmentid_packageid_requestedby~");
            ...
            modelBuilder.Entity("Altinn.AccessMgmt.PersistenceEF.Models.RequestAssignmentResource", b =>
                {
                    ...
                    b.HasIndex("RequestedById")
                        .HasDatabaseName("ix_requestassignmentresource_requestedbyid");

                    b.HasIndex("ResourceId")
                        .HasDatabaseName("ix_requestassignmentresource_resourceid");

                    b.HasIndex("AssignmentId", "ResourceId", "Action", "RequestedById", "Status")
                        .IsUnique()
                        .HasDatabaseName("ix_requestassignmentresource_assignmentid_resourceid_action_re~");
            ...
            modelBuilder.Entity("Altinn.AccessMgmt.PersistenceEF.Models.RequestAssignment", b =>
                {
                    ...
                    b.HasOne("Altinn.AccessMgmt.PersistenceEF.Models.Entity", "RequestedBy")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_requestassignment_entity_requestedbyid");
            ...
            modelBuilder.Entity("Altinn.AccessMgmt.PersistenceEF.Models.RequestAssignmentPackage", b =>
                {
                    ...
                    b.HasOne("Altinn.AccessMgmt.PersistenceEF.Models.Entity", "RequestedBy")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_requestassignmentpackage_entity_requestedbyid");
            ...
            modelBuilder.Entity("Altinn.AccessMgmt.PersistenceEF.Models.RequestAssignmentResource", b =>
                {
                    ...
                    b.HasOne("Altinn.AccessMgmt.PersistenceEF.Models.Entity", "RequestedBy")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_requestassignmentresource_entity_requestedbyid");
