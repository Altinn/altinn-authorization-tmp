...
public class RolePackageConfiguration : IEntityTypeConfiguration<RolePackage>
{
    public void Configure(EntityTypeBuilder<RolePackage> builder)
    {
        ...
        builder.PropertyWithReference(navKey: t => t.EntityVariant, foreignKey: t => t.EntityVariantId, principalKey: t => t.Id, required: false, deleteBehavior: DeleteBehavior.Cascade);
