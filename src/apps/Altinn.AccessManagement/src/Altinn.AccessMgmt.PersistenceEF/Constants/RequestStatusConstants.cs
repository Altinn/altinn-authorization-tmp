...
public static class RequestStatusConstants
{
    ...
    /// <summary>
    /// Represents the Pending request status.
    /// </summary>
    /// <remarks>
    /// - <c>Id:</c> !!!!!!!!!!!!!NEWGUID!!!!!!!!!!!!!!!!
    /// - <c>Name:</c> "Avventer"
    /// - <c>Description:</c> "Forespørselen venter på behandling"
    /// </remarks>
    public static ConstantDefinition<RequestStatus> Pending { get; } = new ConstantDefinition<RequestStatus>("!!!!!!!!!!!!!NEWGUID!!!!!!!!!!!!!!!!")
    {
        Entity = new()
        {
            Name = "Avventer",
            Description = "Forespørselen venter på behandling"
        },
        EN = TranslationEntryList.Create(
            KeyValuePair.Create("Name", "Pending"),
            KeyValuePair.Create("Description", "Request is pending")),
        NN = TranslationEntryList.Create(
            KeyValuePair.Create("Name", "Avventer"),
            KeyValuePair.Create("Description", "Forespørselen venter på behandling")),
    };
