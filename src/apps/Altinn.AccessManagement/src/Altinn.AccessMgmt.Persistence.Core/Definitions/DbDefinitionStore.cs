...
/// </summary>
[Obsolete]
public static class DbDefinitionStore
{
    /// <summary>
    ...
    public static void Define<T>(Action<DbDefinitionBuilder<T>> configure)
    {
    ...
    public static void Define<T>(DbDefinitionBuilder<T> builder)
    {
        Store.AddOrUpdate(
            typeof(T),
            _ => builder.Build(), // Add
