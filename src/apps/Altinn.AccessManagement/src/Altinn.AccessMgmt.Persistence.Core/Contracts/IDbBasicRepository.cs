...
public interface IDbBasicRepository<T>
{
    ...
    /// </returns>
    Task<int> Create(T entity, ChangeRequestOptions options = null, [CallerMemberName] string callerName = "", CancellationToken cancellationToken = default);
    ...
    /// A task that represents the asynchronous operation. The task result contains the number of rows affected.
    /// </returns>
    Task<int> Upsert(T entity, ChangeRequestOptions options = null, [CallerMemberName] string callerName = "", CancellationToken cancellationToken = default);
    ...
    /// A task that represents the asynchronous operation. The task result contains the number of rows affected.
    /// </returns>
    Task<int> Upsert(T entity, List<GenericFilter> mergeFilter, ChangeRequestOptions options = null, [CallerMemberName] string callerName = "", CancellationToken cancellationToken = default);
    ...
    /// A task that represents the asynchronous operation. The task result contains the number of rows affected.
    /// </returns>
    Task<int> Update(Guid id, T entity, ChangeRequestOptions options = null, [CallerMemberName] string callerName = "", CancellationToken cancellationToken = default);
    ...
    /// A task that represents the asynchronous operation. The task result contains the number of rows affected.
    /// </returns>
    Task<int> Update<TProperty>(Expression<Func<T, TProperty>> property, TProperty value, Guid id, ChangeRequestOptions options = null, [CallerMemberName] string callerName = "", CancellationToken cancellationToken = default);
    ...
    /// A task that represents the asynchronous operation. The task result contains the number of rows affected.
    /// </returns>
    Task<int> Update<TProperty>(Expression<Func<T, TProperty>> property, Guid id, ChangeRequestOptions options = null, [CallerMemberName] string callerName = "", CancellationToken cancellationToken = default);
    ...
    /// A task that represents the asynchronous operation. The task result contains the number of rows affected.
    /// </returns>
    Task<int> Update(Guid id, List<GenericParameter> parameters, ChangeRequestOptions options = null, [CallerMemberName] string callerName = "", CancellationToken cancellationToken = default);
    ...
    /// A task that represents the asynchronous operation. The task result contains the number of rows affected.
    /// </returns>
    Task<int> Delete(Guid id, ChangeRequestOptions options = null, [CallerMemberName] string callerName = "", CancellationToken cancellationToken = default);
    ...
    /// A task that represents the asynchronous operation. The task result contains the number of rows affected.
    /// </returns>
    Task<int> Delete(IEnumerable<GenericFilter> filters, ChangeRequestOptions options = null, [CallerMemberName] string callerName = "", CancellationToken cancellationToken = default);
    ...
    /// A task that represents the asynchronous operation. The task result contains the number of rows affected.
    /// </returns>
    Task<int> CreateTranslation(T obj, string language, ChangeRequestOptions options = null, [CallerMemberName] string callerName = "", CancellationToken cancellationToken = default);
    ...
    /// A task that represents the asynchronous operation. The task result contains the number of rows affected.
    /// </returns>
    Task<int> UpdateTranslation(Guid id, T obj, string language, ChangeRequestOptions options = null, [CallerMemberName] string callerName = "", CancellationToken cancellationToken = default);
    ...
    /// <param name="language">The language code for which the translation is to be updated.</param>
    /// <param name="options">Options used for changing data</param>
    /// <param name="callerName">na</param>
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>
    /// A task that represents the asynchronous operation. The task result contains the number of rows affected.
    /// </returns>
    Task<int> UpsertTranslation(Guid id, T obj, string language, ChangeRequestOptions options = null, [CallerMemberName] string callerName = "", CancellationToken cancellationToken = default);
