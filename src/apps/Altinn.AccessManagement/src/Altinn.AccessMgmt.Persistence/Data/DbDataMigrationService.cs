        ...
        )
{
    ...
    public async Task IngestRole(ChangeRequestOptions options, CancellationToken cancellationToken = default)
    {
        ...
        var roles = new List<Role>() 
        {
            ...
            new Role() { Id = Guid.Parse("c2884487-a634-4537-95b4-bafb917b62a8"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Ansvarlig revisor",                            Code = "A0237",               Description = "Delegerbar revisorrolle med signeringsrettighet.Ved regelverksendringer eller innføring av nye digitale tjenester kan det bli endringer i tilganger som rollen gir.", Urn = "urn:altinn:rolecode:A0237", IsKeyRole = false },
            ...
            new Role() { Id = Guid.Parse("df34b69a-e0aa-4245-a840-3a850769b2bd"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Taushetsbelagt post - oppvekst og utdanning",  Code = "A0287",               Description = "Gir tilgang til taushetsbelagt post fra det offentlige innen oppvekst og utdanning", Urn = "urn:altinn:rolecode:A0287", IsKeyRole = false },
            ...
            new Role() { Id = Guid.Parse("1225bc46-4b03-4b63-b6e8-58926b29a97b"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Eksplisitt tjenestedelegering",                Code = "EKTJ",                Description = "Ikke-delegerbar roller for tjenester som kun skal delegeres enkeltvis", Urn = "urn:altinn:rolecode:EKTJ", IsKeyRole = false },
            new Role() { Id = Guid.Parse("cde501eb-0d23-410b-b728-00ab9d68fb2e"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Godkjenning av bedriftshelsetjeneste",         Code = "GKBHT",               Description = "Godkjenning av bedriftshelsetjeneste", Urn = "urn:altinn:rolecode:GKBHT", IsKeyRole = false },
            new Role() { Id = Guid.Parse("d9e05d40-9849-4982-bf04-aa03b19e4a66"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Hovedadministrator",                           Code = "HADM",                Description = "Denne rollen gir mulighet for å delegere alle roller og rettigheter for en aktør, også de man ikke har selv. Hovedadministrator-rollen kan bare delegeres av daglig leder, styrets leder, innehaver og bestyrende reder.", Urn = "urn:altinn:rolecode:HADM", IsKeyRole = false },
            ...
            new Role() { Id = Guid.Parse("e427a9fb-4b6b-44b3-b873-689d174283b8"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Signerer av Samordnet registermelding",        Code = "SIGNE",               Description = "Denne rollen gir rettighet til tjenester på vegne av enheter/foretak. Ved regelverksendringer eller innføring av nye digitale tjenester kan det bli endringer i tilganger som rollen gir.", Urn = "urn:altinn:rolecode:SIGNE", IsKeyRole = false },
            new Role() { Id = Guid.Parse("16857e39-441f-4dd4-8592-aed94e816c04"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Begrenset signeringsrettighet",                Code = "SISKD",               Description = "Tilgang til å signere utvalgte skjema og tjenester. Ved regelverksendringer eller innføring av nye digitale tjenester kan det bli endringer i tilganger som rollen gir.", Urn = "urn:altinn:rolecode:SISKD", IsKeyRole = false },
            new Role() { Id = Guid.Parse("b1213d79-03fa-4837-9193-e4b9fe24eccb"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Helse-, sosial- og velferdstjenester",         Code = "UIHTL",               Description = "Tilgang til helse-, sosial- og velferdsrelaterte tjenester. Ved regelverksendringer eller innføring av nye digitale tjenester kan det bli endringer i tilganger som rollen gir.", Urn = "urn:altinn:rolecode:UIHTL", IsKeyRole = false },
            ...
            new Role() { Id = Guid.Parse("e16ab886-1e1e-4f45-8f79-46f06f720f3e"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Selvregistrert bruker",                        Code = "SELN",               Description = "Selvregistrert bruker", Urn = "urn:altinn:rolecode:SELN", IsKeyRole = false }
        };
        ...
        var rolesEng = new List<Role>()
        {
            ...
            new Role() { Id = Guid.Parse("c497b499-7e98-423d-9fe7-ad5a6c3b71ad"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Primary industry and foodstuff",                    Code = "A0212",               Description = "Import, processing, production and/or sales of primary products and other foodstuff. In case of regulatory changes or the introduction of new digital services, there may be changes in access that the role provides.", Urn = "urn:altinn:rolecode:A0212" },
            new Role() { Id = Guid.Parse("151955ec-d8aa-4c14-a435-ffa96b26a9fb"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Mail/archive",                                      Code = "A0236",               Description = "Access to read correpondences. In case of regulatory changes or the introduction of new digital services, there may be changes in access that the role provides.", Urn = "urn:altinn:rolecode:A0236" },
            new Role() { Id = Guid.Parse("c2884487-a634-4537-95b4-bafb917b62a8"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Auditor in charge",                                 Code = "A0237",               Description = "Delegateble auditor role with signing right. In case of regulatory changes or the introduction of new digital services, there may be changes in access that the role provides.", Urn = "urn:altinn:rolecode:A0237" },
            new Role() { Id = Guid.Parse("10fcad57-7a91-4e02-a921-63e5751fbc24"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Assistant auditor",                                 Code = "A0238",               Description = "Delegateble auditor role without signing right. In case of regulatory changes or the introduction of new digital services, there may be changes in access that the role provides.", Urn = "urn:altinn:rolecode:A0238" },
            new Role() { Id = Guid.Parse("ebed65a5-dd87-4180-b898-e1da249b128d"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Accountant with signing rights",                    Code = "A0239",               Description = "Delegateble accountant role with signing right. In case of regulatory changes or the introduction of new digital services, there may be changes in access that the role provides.", Urn = "urn:altinn:rolecode:A0239" },
            new Role() { Id = Guid.Parse("9407620b-21b6-4538-b4d8-2b4eb339c373"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Accountant without signing rights",                 Code = "A0240",               Description = "Delegateble accountant role without signing right. In case of regulatory changes or the introduction of new digital services, there may be changes in access that the role provides.", Urn = "urn:altinn:rolecode:A0240" },
            new Role() { Id = Guid.Parse("723a43ab-13d8-4585-81e2-e4c734b2d4fc"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Accountant salary",                                 Code = "A0241",               Description = "Delegateble accountant role with signing right to services related to salary. In case of regulatory changes or the introduction of new digital services, there may be changes in access that the role provides.", Urn = "urn:altinn:rolecode:A0241" },
            new Role() { Id = Guid.Parse("6828080b-e846-4c51-b670-201af4917562"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Planning and construction",                         Code = "A0278",               Description = "The role is reserved for forms and services approved by Norwegian Building Authority (DiBK). In case of regulatory changes or the introduction of new digital services, there may be changes in access that the role provides.", Urn = "urn:altinn:rolecode:A0278" },
            new Role() { Id = Guid.Parse("f4df0522-3034-405b-a9e5-83f971737033"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Private tax affairs",                               Code = "A0282",               Description = "The permission applies to all information about your own or your sole proprietorship’s tax affairs. In case of changes to regulations or implementation of new digital services, the Tax Administration may change the permission.", Urn = "urn:altinn:rolecode:A0282" },
            new Role() { Id = Guid.Parse("92ea5544-ca64-4e03-9532-646b9f86ff65"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Confidential information",                          Code = "A0286",               Description = "This role provides access to confidential information from public agencies. In the event of regulatory changes or the introduction of new digital services, there may be changes in access that the role provides.", Urn = "urn:altinn:rolecode:A0286" },
            new Role() { Id = Guid.Parse("df34b69a-e0aa-4245-a840-3a850769b2bd"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Confidential - education",                          Code = "A0287",               Description = "This role provides access to confidential information from public agencies", Urn = "urn:altinn:rolecode:A0287" },
            new Role() { Id = Guid.Parse("5fda4732-dd10-416d-b876-9e1715bbf21c"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Conficential - administration",                     Code = "A0288",               Description = "This role provides access to confidential information from public agencies", Urn = "urn:altinn:rolecode:A0288" },
            new Role() { Id = Guid.Parse("4652e98f-7a6b-4dc2-b061-fc8d6840e456"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Algea test data",                                   Code = "A0293",               Description = "Havforskningsinstituttet - registration of algea test data", Urn = "urn:altinn:rolecode:A0293" },
            new Role() { Id = Guid.Parse("c22c6add-dd5d-4735-87de-b75491018e50"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Transport permit guarantee",                        Code = "A0294",               Description = "The Norwegian Public Roads Administration - role that provides access to the app for transport permi", Urn = "urn:altinn:rolecode:A0294" },
            new Role() { Id = Guid.Parse("d8b9c47b-e5a7-4912-8aa8-1d2bab75e41c"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Auditor certifier",                                 Code = "A0298",               Description = "The role gives the user access to certify services for the reportee as an auditor. In the event of regulatory changes or the introduction of new digital services, there may be changes in access that the role provides..", Urn = "urn:altinn:rolecode:A0298" },
            new Role() { Id = Guid.Parse("48f9e5ec-efd5-4863-baba-9697b8971666"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Access manager",                                    Code = "ADMAI",               Description = "Administration of access", Urn = "urn:altinn:rolecode:ADMAI" },
            new Role() { Id = Guid.Parse("e078bb18-f55a-4a2d-8964-c599f41b29b5"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Application Programming Interface (API)",           Code = "APIADM",              Description = "Delegable role that provides access to manage access to APIs on behalf of the business.", Urn = "urn:altinn:rolecode:APIADM" },
            new Role() { Id = Guid.Parse("0ea4e5de-3fb4-499e-b013-1e1b4459af24"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Application Programming Interface for NUF (API)",   Code = "APIADMNUF",           Description = "Delegable role that provides the representative for a Norwegian-registered foreign enterprise (NUF) access to manage access to the programming interface - API, on behalf of the business.", Urn = "urn:altinn:rolecode:APIADMNUF" },
            new Role() { Id = Guid.Parse("60abf944-cf8c-4845-b310-83bcb6c77198"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Auditor certifies validity of VAT compensation",    Code = "ATTST",               Description = "Certification by auditor of RF-0009", Urn = "urn:altinn:rolecode:ATTST" },
            new Role() { Id = Guid.Parse("0a76304e-345b-4f22-bb31-4837a630eb7a"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Bankruptcy administrator",                          Code = "BOADM",               Description = "Applies to lawyers and gives opportunity to manage access to bankruptcies", Urn = "urn:altinn:rolecode:BOADM" },
            new Role() { Id = Guid.Parse("7246639c-137b-4981-b172-6134c9fc1a7f"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Bankruptcy read",                                   Code = "BOBEL",               Description = "Reading rights for information in the service Konkursbehandling (bankruptcy proceedings)", Urn = "urn:altinn:rolecode:BOBEL" },
            new Role() { Id = Guid.Parse("5f73b031-8b5b-45d8-a682-e9a7e75a7691"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Bankruptcy write",                                  Code = "BOBES",               Description = "Writing rights for information in the service Konkursbehandling (bankruptcy proceedings)", Urn = "urn:altinn:rolecode:BOBES" },
            new Role() { Id = Guid.Parse("e0684f66-a46e-4706-a754-8889b532509c"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "ECKEYROLE",                                         Code = "ECKEYROLE",           Description = "Key role for enterprise users", Urn = "urn:altinn:rolecode:ECKEYROLE" },
            new Role() { Id = Guid.Parse("1225bc46-4b03-4b63-b6e8-58926b29a97b"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Explicit service delegation",                       Code = "EKTJ",                Description = "Non-delegable role for services to be delegated as single rights", Urn = "urn:altinn:rolecode:EKTJ" },
            new Role() { Id = Guid.Parse("cde501eb-0d23-410b-b728-00ab9d68fb2e"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Godkjenning av bedriftshelsetjeneste",              Code = "GKBHT",               Description = "Godkjenning av bedriftshelsetjeneste", Urn = "urn:altinn:rolecode:GKBHT" },
            new Role() { Id = Guid.Parse("d9e05d40-9849-4982-bf04-aa03b19e4a66"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Main Administrator",                                Code = "HADM",                Description = "This role allows you to delegate all roles and rights for an actor, including those you do not have yourself. The Main administrator role can only be delegated by General manager, Chairman of the board, Soul proprietor and Managing shipowner.", Urn = "urn:altinn:rolecode:HADM" },
            new Role() { Id = Guid.Parse("98bebcac-d6bb-4343-97b8-0fe8bc744d7a"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Økokrim reporting",                                 Code = "HVASK",               Description = "Access to services from The Norwegian National Authority for Investigation and Prosecution of Economic and Environmental Crime. In case of regulatory changes or the introduction of new digital services, there may be changes in access that the role provide", Urn = "urn:altinn:rolecode:HVASK" },
            new Role() { Id = Guid.Parse("27e1ef41-df4d-439e-b948-df136c139e81"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Client administrator",                              Code = "KLADM",               Description = "Administration of access to client roles for accountants and auditors", Urn = "urn:altinn:rolecode:KLADM" },
            new Role() { Id = Guid.Parse("b8e6dd1c-ca10-4ce6-9c27-53cdb3c275b3"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Municipal services",                                Code = "KOMAB",               Description = "Role for municipal services. In case of regulatory changes or the introduction of new digital services, there may be changes in access that the role provides.", Urn = "urn:altinn:rolecode:KOMAB" },
            new Role() { Id = Guid.Parse("010b4c49-bf56-44e3-b73b-84be7b2a5eb6"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Salaries and personnel employee",                   Code = "LOPER",               Description = "Access to services related to salaries and personnel", Urn = "urn:altinn:rolecode:LOPER" },
            new Role() { Id = Guid.Parse("0f276fc4-c201-4ff7-8e8a-caa3efe9c02a"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Parallel signing",                                  Code = "PASIG",               Description = "Right to sign elements from other reportees", Urn = "urn:altinn:rolecode:PASIG" },
            new Role() { Id = Guid.Parse("23cade0a-287a-49e0-8957-22d5a14cb100"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Patents, trademarks and design",                    Code = "PAVAD",               Description = "Access to services related to patents, trademarks and design. In case of regulatory changes or the introduction of new digital services, there may be changes in access that the role provides.", Urn = "urn:altinn:rolecode:PAVAD" },
            new Role() { Id = Guid.Parse("696478f4-c85b-4bda-ace0-caa058fe5def"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Limited rights for an individual",                  Code = "PRIUT",               Description = "Delegable rights to services for individuals. In case of regulatory changes or the introduction of new digital services, there may be changes in access that the role provides.", Urn = "urn:altinn:rolecode:PRIUT" },
            new Role() { Id = Guid.Parse("633cde7d-3604-45b2-ba8c-e16161cf2cf8"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Accounting employee",                               Code = "REGNA",               Description = "Access to accounting related forms and services. In case of regulatory changes or the introduction of new digital services, there may be changes in access that the role provides.", Urn = "urn:altinn:rolecode:REGNA" },
            new Role() { Id = Guid.Parse("1d71e23d-91b6-44ca-b171-c179028e7cdf"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Auditor's rights",                                  Code = "REVAI",               Description = "Delegable auditor's rights", Urn = "urn:altinn:rolecode:REVAI" },
            new Role() { Id = Guid.Parse("1a15b75c-2387-4278-ba3a-7eb1cffe1653"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Confidential correspondence from the municipality", Code = "SENS01",              Description = "This role provides access to services with confidential information from the municipality", Urn = "urn:altinn:rolecode:SENS01" },
            new Role() { Id = Guid.Parse("e427a9fb-4b6b-44b3-b873-689d174283b8"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Signer of Coordinated register notification",       Code = "SIGNE",               Description = "Applies to singing on behalf of entities/businesses. In case of regulatory changes or the introduction of new digital services, there may be changes in access that the role provides.", Urn = "urn:altinn:rolecode:SIGNE" },
            new Role() { Id = Guid.Parse("16857e39-441f-4dd4-8592-aed94e816c04"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Limited signing rights",                            Code = "SISKD",               Description = "Signing access for selected forms and services.In case of regulatory changes or the introduction of new digital services, there may be changes in access that the role provides.", Urn = "urn:altinn:rolecode:SISKD" },
            new Role() { Id = Guid.Parse("b1213d79-03fa-4837-9193-e4b9fe24eccb"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Health-, social- and welfare services",             Code = "UIHTL",               Description = "Access to health-, social- and welfare related services. In case of regulatory changes or the introduction of new digital services, there may be changes in access that the role provides.", Urn = "urn:altinn:rolecode:UIHTL" },
            ...
            new Role() { Id = Guid.Parse("e16ab886-1e1e-4f45-8f79-46f06f720f3e"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Self registered user",                              Code = "SELN",                Description = "Self registered user", Urn = "urn:altinn:rolecode:SELN", IsKeyRole = false }
        ...
        var rolesNno = new List<Role>()
        {
            ...
            new Role() { Id = Guid.Parse("c2884487-a634-4537-95b4-bafb917b62a8"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Ansvarleg revisor",                         Code = "A0237",               Description = "Delegerbar revisorrolle med signeringsrett. Ved regelverksendringar eller innføring av nye digitale tenester kan det bli endringar i tilgangar som rolla gir", Urn = "urn:altinn:rolecode:A0237" },
            new Role() { Id = Guid.Parse("10fcad57-7a91-4e02-a921-63e5751fbc24"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Revisormedarbeidar",                        Code = "A0238",               Description = "Delegerbar revisorrolle utan signeringsrett. Ved regelverksendringar eller innføring av nye digitale tenester kan det bli endringar i tilgangar som rolla gir", Urn = "urn:altinn:rolecode:A0238" },
            new Role() { Id = Guid.Parse("ebed65a5-dd87-4180-b898-e1da249b128d"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Rekneskapsførar med signeringsrett",        Code = "A0239",               Description = "Delegerbar rekneskapsrolle med signeringsrett. Ved regelverksendringar eller innføring av nye digitale tenester kan det bli endringar i tilgangar som rolla gir", Urn = "urn:altinn:rolecode:A0239" },
            new Role() { Id = Guid.Parse("9407620b-21b6-4538-b4d8-2b4eb339c373"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Rekneskapsførar utan signeringsrett",       Code = "A0240",               Description = "Delegerbar rekneskapsrolle utan signeringsrett. Ved regelverksendringar eller innføring av nye digitale tenester kan det bli endringar i tilgangar som rolla gir", Urn = "urn:altinn:rolecode:A0240" },
            new Role() { Id = Guid.Parse("723a43ab-13d8-4585-81e2-e4c734b2d4fc"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Rekneskapsførar løn",                       Code = "A0241",               Description = "Delegerbar rekneskapsrolle med signeringsrett for tenester knytta til lønsrapportering. Ved regelverksendringar eller innføring av nye digitale tenester kan det bli endringar i tilgangar som rolla gir", Urn = "urn:altinn:rolecode:A0241" },
            ...
            new Role() { Id = Guid.Parse("f4df0522-3034-405b-a9e5-83f971737033"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Skatteforhold for privatpersonar",          Code = "A0282",               Description = "Løyvet gjeld alle opplysningar om skatteforholda dine og om skatteforholda for enkeltpersonføretaket ditt. Ved regelverksendringar eller innføring av nye digitale tenester kan Skatteetaten endre løyvet.", Urn = "urn:altinn:rolecode:A0282" },
            new Role() { Id = Guid.Parse("92ea5544-ca64-4e03-9532-646b9f86ff65"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Taushetslagd post",                         Code = "A0286",               Description = "Gir tlgang til taushetslagd post frå det offentlige. Ved regelverksendringer eller innføring av nye digitale tenester kan det bli endringer i tilganger som rollen gir", Urn = "urn:altinn:rolecode:A0286" },
            new Role() { Id = Guid.Parse("df34b69a-e0aa-4245-a840-3a850769b2bd"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Taushetslagd post - oppvekst og utdanning", Code = "A0287",               Description = "Gir tlgang til taushetslagd post frå det offentlige innan oppvekst og utdanning", Urn = "urn:altinn:rolecode:A0287" },
            new Role() { Id = Guid.Parse("5fda4732-dd10-416d-b876-9e1715bbf21c"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Taushetslagd post - administrasjon",        Code = "A0288",               Description = "Gir tlgang til taushetslagd post frå det offentlige innan administrasjon", Urn = "urn:altinn:rolecode:A0288" },
            new Role() { Id = Guid.Parse("4652e98f-7a6b-4dc2-b061-fc8d6840e456"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Algetestdata",                              Code = "A0293",               Description = "Havforskningsinstituttet - registrering av algetestdata", Urn = "urn:altinn:rolecode:A0293" },
            new Role() { Id = Guid.Parse("c22c6add-dd5d-4735-87de-b75491018e50"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Transportløyvegaranti",                     Code = "A0294",               Description = "Statens vegvesen - rolle som gjer tilgang til app for transportløuvegarantistar", Urn = "urn:altinn:rolecode:A0294" },
            new Role() { Id = Guid.Parse("d8b9c47b-e5a7-4912-8aa8-1d2bab75e41c"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Revisorattesterar",                         Code = "A0298",               Description = "Rollen gir bruker tilgang til å attestere tjenester for avgiver som revisor. Ved regelverksendringer eller innføring av nye digitale tenester kan det bli endringer i tilganger som rollen gir", Urn = "urn:altinn:rolecode:A0298" },
            new Role() { Id = Guid.Parse("48f9e5ec-efd5-4863-baba-9697b8971666"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Tilgangsstyring",                           Code = "ADMAI",               Description = "Administrasjon av tilgangar", Urn = "urn:altinn:rolecode:ADMAI" },
            new Role() { Id = Guid.Parse("e078bb18-f55a-4a2d-8964-c599f41b29b5"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Programmeringsgrensesnitt (API)",           Code = "APIADM",              Description = "Delegerbar rolle som gir tilgang til å administrere tilgang til programmeringsgrensesnitt - API, på vegne av verksemden.", Urn = "urn:altinn:rolecode:APIADM" },
            new Role() { Id = Guid.Parse("0ea4e5de-3fb4-499e-b013-1e1b4459af24"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Programmeringsgrensesnitt for NUF (API)",   Code = "APIADMNUF",           Description = "Delegerbar rolle som gir kontaktperson for norskregistrert utanlandsk føretak (NUF) tilgang til å administrere tilgang til programmeringsgrensesnitt - API, på vegne av verksemden", Urn = "urn:altinn:rolecode:APIADMNUF" },
            new Role() { Id = Guid.Parse("60abf944-cf8c-4845-b310-83bcb6c77198"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Revisorattesterar - MVA kompensasjon",      Code = "ATTST",               Description = "Revisor si attestering av RF-0009", Urn = "urn:altinn:rolecode:ATTST" },
            new Role() { Id = Guid.Parse("0a76304e-345b-4f22-bb31-4837a630eb7a"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Konkursbu tilgangsstyring",                 Code = "BOADM",               Description = "Gjeld advokatar og gjev moglegheit for tilgangsstyring av konkursbu", Urn = "urn:altinn:rolecode:BOADM" },
            new Role() { Id = Guid.Parse("7246639c-137b-4981-b172-6134c9fc1a7f"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Konkursbu lesetilgang",                     Code = "BOBEL",               Description = "Tilgang til å lese informasjon i tenesta Konkursbehandling", Urn = "urn:altinn:rolecode:BOBEL" },
            new Role() { Id = Guid.Parse("5f73b031-8b5b-45d8-a682-e9a7e75a7691"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Konkursbu skrivetilgang",                   Code = "BOBES",               Description = "Tilgang til å skrive informasjon i tenesta Konkursbehandling", Urn = "urn:altinn:rolecode:BOBES" },
            new Role() { Id = Guid.Parse("e0684f66-a46e-4706-a754-8889b532509c"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "ECKEYROLE",                                 Code = "ECKEYROLE",           Description = "Nøkkelrolle for virksomhetsertifikatbrukere", Urn = "urn:altinn:rolecode:ECKEYROLE" },
            new Role() { Id = Guid.Parse("1225bc46-4b03-4b63-b6e8-58926b29a97b"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Eksplisitt tenestedelegering",              Code = "EKTJ",                Description = "Ikkje-delegerbar rolle for tenester som kun skal delegerast enkeltvis", Urn = "urn:altinn:rolecode:EKTJ" },
            new Role() { Id = Guid.Parse("cde501eb-0d23-410b-b728-00ab9d68fb2e"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Godkjenning av bedriftshelsetjeneste",      Code = "GKBHT",               Description = "Godkjenning av bedriftshelsetjeneste", Urn = "urn:altinn:rolecode:GKBHT" },
            new Role() { Id = Guid.Parse("d9e05d40-9849-4982-bf04-aa03b19e4a66"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Hovudadministrator",                        Code = "HADM",                Description = "Denne rolla gir høve til å delegere alle roller og rettar for ein aktør, også dei ein ikkje har sjøl", Urn = "urn:altinn:rolecode:HADM" },
            new Role() { Id = Guid.Parse("98bebcac-d6bb-4343-97b8-0fe8bc744d7a"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Økokrim rapportering",                      Code = "HVASK",               Description = "Tilgang til tenester frå Økokrim. Ved regelverksendringar eller innføring av nye digitale tenester kan det bli endringar i tilgangar som rolla gir", Urn = "urn:altinn:rolecode:HVASK" },
            new Role() { Id = Guid.Parse("27e1ef41-df4d-439e-b948-df136c139e81"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Klientadministrator",                       Code = "KLADM",               Description = "Tilgang til å administrere klientroller for rekneskapsførarar og revisorar", Urn = "urn:altinn:rolecode:KLADM" },
            new Role() { Id = Guid.Parse("b8e6dd1c-ca10-4ce6-9c27-53cdb3c275b3"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Kommunale tenester",                        Code = "KOMAB",               Description = "Rolle for kommunale tenester. Ved regelverksendringar eller innføring av nye digitale tenester kan det bli endringar i tilgangar som rolla gir", Urn = "urn:altinn:rolecode:KOMAB" },
            new Role() { Id = Guid.Parse("010b4c49-bf56-44e3-b73b-84be7b2a5eb6"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Løn og personalmedarbeidar",                Code = "LOPER",               Description = "Tilgang til løns- og personalrelaterte tenester. Ved regelverksendringar eller innføring av nye digitale tenester kan det bli endringar i tilgangar som rolla gir", Urn = "urn:altinn:rolecode:LOPER" },
            new Role() { Id = Guid.Parse("0f276fc4-c201-4ff7-8e8a-caa3efe9c02a"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Parallell signering",                       Code = "PASIG",               Description = "Rett til å signere elementer frå andre avgjevarar", Urn = "urn:altinn:rolecode:PASIG" },
            ...
            new Role() { Id = Guid.Parse("633cde7d-3604-45b2-ba8c-e16161cf2cf8"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Rekneskapsmedarbeidar",                     Code = "REGNA",               Description = "Tilgang til rekneskapsrelaterte skjema og tenester. Ved regelverksendringar eller innføring av nye digitale tenester kan det bli endringar i tilgangar som rolla gir", Urn = "urn:altinn:rolecode:REGNA" },
            new Role() { Id = Guid.Parse("1d71e23d-91b6-44ca-b171-c179028e7cdf"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Revisorrett",                               Code = "REVAI",               Description = "Delegerbare revisorrettar", Urn = "urn:altinn:rolecode:REVAI" },
            new Role() { Id = Guid.Parse("1a15b75c-2387-4278-ba3a-7eb1cffe1653"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Taushetslagd post frå kommunen",            Code = "SENS01",              Description = "Rolla gir tilgang til tenester med taushetsalgd informasjon frå kommunen.", Urn = "urn:altinn:rolecode:SENS01" },
            new Role() { Id = Guid.Parse("e427a9fb-4b6b-44b3-b873-689d174283b8"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Signerar av Samordna registermelding",      Code = "SIGNE",               Description = "Gjeld for signering på vegne av einingar/føretak. Ved regelverksendringar eller innføring av nye digitale tenester kan det bli endringar i tilgangar som rolla gir", Urn = "urn:altinn:rolecode:SIGNE" },
            new Role() { Id = Guid.Parse("16857e39-441f-4dd4-8592-aed94e816c04"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Avgrensa signeringsrett",                   Code = "SISKD",               Description = "Tilgang til å signere utvalde skjema og tenester. Ved regelverksendringar eller innføring av nye digitale tenester kan det bli endringar i tilgangar som rolla gir", Urn = "urn:altinn:rolecode:SISKD" },
            new Role() { Id = Guid.Parse("b1213d79-03fa-4837-9193-e4b9fe24eccb"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Helse-, sosial- og velferdstenester",       Code = "UIHTL",               Description = "Tilgang til helse-, sosial- og velferdsrelaterte tenester. Ved regelverksendringar eller innføring av nye digitale tenester kan det bli endringar i tilgangar som rolla gir", Urn = "urn:altinn:rolecode:UIHTL" },
            ...
            new Role() { Id = Guid.Parse("e16ab886-1e1e-4f45-8f79-46f06f720f3e"), EntityTypeId = orgEntityTypeId,  ProviderId = a2ProviderId, Name = "Sjølregistrert brukar",                     Code = "SELN",               Description = "Sjølregistrert brukar", Urn = "urn:altinn:rolecode:SELN", IsKeyRole = false }
        };
