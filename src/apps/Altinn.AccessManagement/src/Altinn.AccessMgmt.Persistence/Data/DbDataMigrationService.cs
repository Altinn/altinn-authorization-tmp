        ...
        )
{
    ...
    public async Task IngestAll(CancellationToken cancellationToken = default)
    {
        ...
        if (migrationService.NeedMigration<RolePackage>(dataKey, 10))
        {
            ...
            await migrationService.LogMigration<RolePackage>(dataKey, string.Empty, 10);
        }
    ...
    public async Task IngestSystemEntity(ChangeRequestOptions options, CancellationToken cancellationToken = default)
    {
        ...
        var systemEntities = new List<Entity>()
        {
            ...
            new Entity() { Id = AuditDefaults.Altinn2RoleImportSystem, Name = "Altinn2RoleImportSystem", RefId = "sys-altinn2-role-import-system", ParentId = null, TypeId = internalTypeId, VariantId = internalVariantId },
        };
    ...
    public async Task IngestRole(ChangeRequestOptions options, CancellationToken cancellationToken = default)
    {
        ...
        {
            new Role() { Id = Guid.Parse("42CAE370-2DC1-4FDC-9C67-C2F4B0F0F829"), EntityTypeId = orgEntityTypeId, ProviderId = a3ProviderId,    Name = "Rightholder",                  Code = "rettighetshaver",               Description = "Allows receiving delegated authorizations for the business", Urn = "urn:altinn:role:rettighetshaver" },
            ...
            new Role() { Id = Guid.Parse("ba1c261c-20ec-44e2-9e0b-4e7cfe9f36e7"), EntityTypeId = orgEntityTypeId, ProviderId = a3ProviderId,    Name = "Main Administrator",           Code = "hovedadministrator",            Description = "Internal role to collect all delegable access a main administrator can perform for the business", Urn = "urn:altinn:role:hovedadministrator" },
        ...
        var rolesNno = new List<Role>()
        {
            ...
            new Role() { Id = Guid.Parse("ba1c261c-20ec-44e2-9e0b-4e7cfe9f36e7"), EntityTypeId = orgEntityTypeId, ProviderId = a3ProviderId, Name = "Hovudadministrator",               Code = "hovedadministrator",            Description = "Intern rolle for å samla alle delegerbare fullmakter ein hovudadministrator kan utføra for verksemda", Urn = "urn:altinn:role:hovedadministrator" },
    ...
    public async Task IngestRoleMap(ChangeRequestOptions options, CancellationToken cancellationToken = default)
    {
        ...
        /*KEMN*/
        var roleKemn = (await roleService.Get(t => t.Urn, "urn:altinn:external-role:ccr:kontaktperson-ados")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "kontaktperson-ados"));
        /*PRIV*/
        var rolePriv = (await roleService.Get(t => t.Urn, "urn:altinn:role:privatperson")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "privatperson"));
        /*KOMK*/
        var roleKomk = (await roleService.Get(t => t.Urn, "urn:altinn:external-role:ccr:kontaktperson-kommune")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "kontaktperson-kommune"));
        /*KONT*/
        var roleKont = (await roleService.Get(t => t.Urn, "urn:altinn:external-role:ccr:kontaktperson")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "kontaktperson"));
        /*MEDL*/
        var roleMedl = (await roleService.Get(t => t.Urn, "urn:altinn:external-role:ccr:styremedlem")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "styremedlem"));
        /*MVAG*/
        var roleMvag = (await roleService.Get(t => t.Urn, "urn:altinn:external-role:ccr:mva-signerer")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "mva-signerer"));
        /*MVAU*/
        var roleMvau = (await roleService.Get(t => t.Urn, "urn:altinn:external-role:ccr:mva-utfyller")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "mva-utfyller"));
        /*NEST*/
        var roleNest = (await roleService.Get(t => t.Urn, "urn:altinn:external-role:ccr:nestleder")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "nestleder"));
        /*REPR*/
        ...
        /*SAM*/
        var roleSam = (await roleService.Get(t => t.Urn, "urn:altinn:external-role:ccr:sameier")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "sameier"));
        /*SENS*/
        ...
        /*A0236*/
        var roleA0236 = (await roleService.Get(t => t.Urn, "urn:altinn:rolecode:A0236")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "A0236"));
        /*A0237*/
        var roleA0237 = (await roleService.Get(t => t.Urn, "urn:altinn:rolecode:A0237")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "A0237"));
        /*A0238*/
        var roleA0238 = (await roleService.Get(t => t.Urn, "urn:altinn:rolecode:A0238")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "A0238"));
        /*A0239*/
        var roleA0239 = (await roleService.Get(t => t.Urn, "urn:altinn:rolecode:A0239")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "A0239"));
        /*A0240*/
        var roleA0240 = (await roleService.Get(t => t.Urn, "urn:altinn:rolecode:A0240")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "A0240"));
        /*A0241*/
        var roleA0241 = (await roleService.Get(t => t.Urn, "urn:altinn:rolecode:A0241")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "A0241"));
        /*A0278*/
        var roleA0278 = (await roleService.Get(t => t.Urn, "urn:altinn:rolecode:A0278")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "A0278"));
        /*A0282*/
        var roleA0282 = (await roleService.Get(t => t.Urn, "urn:altinn:rolecode:A0282")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "A0282"));
        /*A0286*/
        var roleA0286 = (await roleService.Get(t => t.Urn, "urn:altinn:rolecode:A0286")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "A0286"));
        /*A0293*/
        var roleA0293 = (await roleService.Get(t => t.Urn, "urn:altinn:rolecode:A0293")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "A0293"));
        /*A0294*/
        var roleA0294 = (await roleService.Get(t => t.Urn, "urn:altinn:rolecode:A0294")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "A0294"));
        /*A0298*/
        var roleA0298 = (await roleService.Get(t => t.Urn, "urn:altinn:rolecode:A0298")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "A0298"));
        /*ADMAI*/
        var roleADMAI = (await roleService.Get(t => t.Urn, "urn:altinn:rolecode:ADMAI")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "ADMAI"));
        /*APIADM*/
        var roleAPIADM = (await roleService.Get(t => t.Urn, "urn:altinn:rolecode:APIADM")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "APIADM"));
        /*APIADMNUF*/
        var roleAPIADMNUF = (await roleService.Get(t => t.Urn, "urn:altinn:rolecode:APIADMNUF")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "APIADMNUF"));
        /*ATTST*/
        var roleATTST = (await roleService.Get(t => t.Urn, "urn:altinn:rolecode:ATTST")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "ATTST"));
        /*BOADM*/
        var roleBOADM = (await roleService.Get(t => t.Urn, "urn:altinn:rolecode:BOADM")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "BOADM"));
        /*BOBEL*/
        var roleBOBEL = (await roleService.Get(t => t.Urn, "urn:altinn:rolecode:BOBEL")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "BOBEL"));
        /*BOBES*/
        var roleBOBES = (await roleService.Get(t => t.Urn, "urn:altinn:rolecode:BOBES")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "BOBES"));
        /*ECKEYROLE*/
        var roleECKEYROLE = (await roleService.Get(t => t.Urn, "urn:altinn:rolecode:ECKEYROLE")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "ECKEYROLE"));
        /*EKTJ*/
        var roleEKTJ = (await roleService.Get(t => t.Urn, "urn:altinn:rolecode:EKTJ")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "EKTJ"));
        /*HADM*/
        var roleHADM = (await roleService.Get(t => t.Urn, "urn:altinn:rolecode:HADM")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "HADM"));
        /*HVASK*/
        var roleHVASK = (await roleService.Get(t => t.Urn, "urn:altinn:rolecode:HVASK")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "HVASK"));
        /*KLADM*/
        var roleKLADM = (await roleService.Get(t => t.Urn, "urn:altinn:rolecode:KLADM")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "KLADM"));
        /*KOMAB*/
        var roleKOMAB = (await roleService.Get(t => t.Urn, "urn:altinn:rolecode:KOMAB")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "KOMAB"));
        /*LOPER*/
        var roleLOPER = (await roleService.Get(t => t.Urn, "urn:altinn:rolecode:LOPER")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "LOPER"));
        /*PASIG*/
        var rolePASIG = (await roleService.Get(t => t.Urn, "urn:altinn:rolecode:PASIG")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "PASIG"));
        /*PAVAD*/
        var rolePAVAD = (await roleService.Get(t => t.Urn, "urn:altinn:rolecode:PAVAD")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "PAVAD"));
        /*PRIUT*/
        var rolePRIUT = (await roleService.Get(t => t.Urn, "urn:altinn:rolecode:PRIUT")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "PRIUT"));
        /*REGNA*/
        var roleREGNA = (await roleService.Get(t => t.Urn, "urn:altinn:rolecode:REGNA")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "REGNA"));
        /*SIGNE*/
        var roleSIGNE = (await roleService.Get(t => t.Urn, "urn:altinn:rolecode:SIGNE")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "SIGNE"));
        /*SISKD*/
        var roleSISKD = (await roleService.Get(t => t.Urn, "urn:altinn:rolecode:SISKD")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "SISKD"));
        /*UIHTL*/
        var roleUIHTL = (await roleService.Get(t => t.Urn, "urn:altinn:rolecode:UIHTL")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "UIHTL"));
        /*UILUF*/
        var roleUILUF = (await roleService.Get(t => t.Urn, "urn:altinn:rolecode:UILUF")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "UILUF"));
        /*UTINN*/
        var roleUTINN = (await roleService.Get(t => t.Urn, "urn:altinn:rolecode:UTINN")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "UTINN"));
        /*UTOMR*/
        var roleUTOMR = (await roleService.Get(t => t.Urn, "urn:altinn:rolecode:UTOMR")).FirstOrDefault()?.Id ?? throw new KeyNotFoundException(string.Format("Role not found '{0}'", "UTOMR"));
    ...
    public async Task IngestPackage(ChangeRequestOptions options, CancellationToken cancellationToken = default)
    {
        ...
        var packages = new List<Package>()
        {
            ...
            new Package() { Id = Guid.Parse("2baf30c2-ba5c-49de-8cce-f8ac27d12690"), ProviderId = provider, EntityTypeId = orgEntityType, AreaId = area_skatt_avgift_regnskap_og_toll, Urn = "urn:altinn:accesspackage:revisjon", Name = "Revisjon", Description = "Denne tilgangspakken gir fullmakter til tjenester knyttet til revisjon. Ved regelverksendringer eller innføring av nye digitale tjenester kan det bli endringer i tilganger som fullmakten gir.", IsDelegable = true, HasResources = true, IsAssignable = true },
            ...
            new Package() { Id = Guid.Parse("1886712b-e077-445a-ab3f-8c8bdebccc67"), ProviderId = provider, EntityTypeId = orgEntityType, AreaId = area_skatt_avgift_regnskap_og_toll, Urn = "urn:altinn:accesspackage:revisorattesterer", Name = "Revisorattesterer", Description = "Denne fullmakten gir tilgang til alle tjenester som krever revisorattestering. Ved regelverksendringer eller innføring av nye digitale tjenester kan det bli endringer i tilganger som fullmakten gir.", IsDelegable = true, HasResources = true, IsAssignable = true },
            ...
            new Package() { Id = Guid.Parse("956cfcf0-ab4c-44d8-98a2-d68c4d59321b"), ProviderId = provider, EntityTypeId = orgEntityType, AreaId = area_forhold_ved_virksomheten, Urn = "urn:altinn:accesspackage:starte-drive-endre-avvikle-virksomhet", Name = "Starte, endre, drive og avvikle virksomhet", Description = "Denne tilgangspakken gir fullmakter til tjenester knyttet til å starte, endre, drive og avvikle en virksomhet. Ved regelverksendringer eller innføring av nye digitale tjenester kan det bli endringer i tilganger som fullmakten gir.", IsDelegable = true, HasResources = true, IsAssignable = true },
            ...
            new Package() { Id = Guid.Parse("1e36b4e3-2eff-4613-9f52-52cde5c1c0f3"), ProviderId = provider, EntityTypeId = orgEntityType, AreaId = area_forhold_ved_virksomheten, Urn = "urn:altinn:accesspackage:teknisk-samhandling-skatt", Name = "Teknisk samhandling med Skatteetaten", Description = "Denne tilgangspakken gir fullmakter til tjenester for å forvalte og koordinere tekniske grensesnitt mot Skatteetaten. Ved regelverksendringer eller innføring av nye digitale tjenester kan det bli endringer i tilganger som fullmakten gir.", IsDelegable = true, HasResources = true, IsAssignable = true },
            new Package() { Id = Guid.Parse("0ef5d123-6dd6-4fca-929b-30148996e926"), ProviderId = provider, EntityTypeId = orgEntityType, AreaId = area_forhold_ved_virksomheten, Urn = "urn:altinn:accesspackage:beredskap", Name = "Beredskap", Description = "Denne tilgangspakken gir fullmakt til tjenester knyttet til etablering, rapportering og varsling av beredskap. Ved regelverksendringer eller innføring av nye digitale tjenester kan det bli endringer i tilganger som fullmakten gir.", IsDelegable = true, HasResources = true, IsAssignable = true },
            new Package() { Id = Guid.Parse("58c282e4-4505-4411-8d8d-62fdaee7f7ed"), ProviderId = provider, EntityTypeId = orgEntityType, AreaId = area_forhold_ved_virksomheten, Urn = "urn:altinn:accesspackage:offentlige-anskaffelser", Name = "Offentlige anskaffelser", Description = "DenneDenne tilgangspakken gir fullmakter til å dele data om virksomheten i forbindelse med offentlige anskaffelser. Ved regelverksendringer eller innføring av nye digitale tjenester kan det bli endringer i tilganger som fullmakten gir.", IsDelegable = true, HasResources = true, IsAssignable = true },
            ...
            new Package() { Id = Guid.Parse("be00ece7-0758-4722-977a-3ec41b1ba1e8"), ProviderId = provider, EntityTypeId = orgEntityType, AreaId = area_transport_og_lagring, Urn = "urn:altinn:accesspackage:kjoretoy", Name = "Kjøretøy", Description = "Denne fullmakten gir tilgang til tjenester knyttet til lagring og hjelpetjenester i forbindelse med transport, samt post- og kurervirksomhet. Ved regelverksendringer eller innføring av nye digitale tjenester kan det bli endringer i tilganger som fullmakten gir.", IsDelegable = true, HasResources = true, IsAssignable = true },
            new Package() { Id = Guid.Parse("01f58e9c-d50a-4063-b88d-753d25fa1f11"), ProviderId = provider, EntityTypeId = orgEntityType, AreaId = area_transport_og_lagring, Urn = "urn:altinn:accesspackage:trafikant", Name = "Trafikant", Description = "Denne fullmakten giir tilgang til tjenester knyttet til førerkort og trafikantinformasjon. Ved regelverksendringer eller innføring av nye digitale tjenester kan det bli endringer i hvilke tilganger denne fullmakten gir.", IsDelegable = true, HasResources = true, IsAssignable = true },
            ...
            new Package() { Id = Guid.Parse("d6f87b4e-650f-44bb-9d8d-f0916a818e1b"), ProviderId = provider, EntityTypeId = orgEntityType, AreaId = area_andre_tjenesteytende_naeringer, Urn = "urn:altinn:accesspackage:posttjenester", Name = "Posttjenester", Description = "Denne fullmakten gir tilgang til tjenester knyttet til posttjenester. Ved regelverksendringer eller innføring av nye digitale tjenester kan det bli endringer i tilganger som fullmakten gir.", IsDelegable = true, HasResources = true, IsAssignable = true },
            new Package() { Id = Guid.Parse("38c6cb40-ec44-45bb-a36d-be1f437a6823"), ProviderId = provider, EntityTypeId = orgEntityType, AreaId = area_andre_tjenesteytende_naeringer, Urn = "urn:altinn:accesspackage:elektronisk-kommunikasjon", Name = "Elektronisk kommunikasjon", Description = "DenneDenne fullmakten gir tilgang til tjenester knyttet til elektronisk kommunikasjon. Ved regelverksendringer eller innføring av nye digitale tjenester kan det bli endringer i tilganger som fullmakten gir.", IsDelegable = true, HasResources = true, IsAssignable = true },
    ...
    public async Task IngestRolePackage(ChangeRequestOptions options, CancellationToken cancellationToken = default)
    {
        ...
        var rolePackages = new List<RolePackage>()
        {
            ...
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:daglig-leder"], PackageId = packages["urn:altinn:accesspackage:kjoretoy"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:styreleder"], PackageId = packages["urn:altinn:accesspackage:kjoretoy"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:innehaver"], PackageId = packages["urn:altinn:accesspackage:kjoretoy"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:deltaker-fullt-ansvar"], PackageId = packages["urn:altinn:accesspackage:kjoretoy"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:deltaker-delt-ansvar"], PackageId = packages["urn:altinn:accesspackage:kjoretoy"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:komplementar"], PackageId = packages["urn:altinn:accesspackage:kjoretoy"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:bestyrende-reder"], PackageId = packages["urn:altinn:accesspackage:kjoretoy"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:bostyrer"], PackageId = packages["urn:altinn:accesspackage:kjoretoy"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:role:hovedadministrator"], PackageId = packages["urn:altinn:accesspackage:kjoretoy"], EntityVariantId = null, CanDelegate = true, HasAccess = false },

            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:daglig-leder"], PackageId = packages["urn:altinn:accesspackage:trafikant"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:styreleder"], PackageId = packages["urn:altinn:accesspackage:trafikant"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:innehaver"], PackageId = packages["urn:altinn:accesspackage:trafikant"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:deltaker-fullt-ansvar"], PackageId = packages["urn:altinn:accesspackage:trafikant"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:deltaker-delt-ansvar"], PackageId = packages["urn:altinn:accesspackage:trafikant"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:komplementar"], PackageId = packages["urn:altinn:accesspackage:trafikant"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:bestyrende-reder"], PackageId = packages["urn:altinn:accesspackage:trafikant"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:bostyrer"], PackageId = packages["urn:altinn:accesspackage:trafikant"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:role:hovedadministrator"], PackageId = packages["urn:altinn:accesspackage:trafikant"], EntityVariantId = null, CanDelegate = true, HasAccess = false },
            ...
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:daglig-leder"], PackageId = packages["urn:altinn:accesspackage:revisjon"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:styreleder"], PackageId = packages["urn:altinn:accesspackage:revisjon"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:innehaver"], PackageId = packages["urn:altinn:accesspackage:revisjon"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:deltaker-fullt-ansvar"], PackageId = packages["urn:altinn:accesspackage:revisjon"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:deltaker-delt-ansvar"], PackageId = packages["urn:altinn:accesspackage:revisjon"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:komplementar"], PackageId = packages["urn:altinn:accesspackage:revisjon"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:bestyrende-reder"], PackageId = packages["urn:altinn:accesspackage:revisjon"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:bostyrer"], PackageId = packages["urn:altinn:accesspackage:revisjon"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:role:hovedadministrator"], PackageId = packages["urn:altinn:accesspackage:revisjon"], EntityVariantId = null, CanDelegate = true, HasAccess = false },
            ...
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:daglig-leder"], PackageId = packages["urn:altinn:accesspackage:posttjenester"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:styreleder"], PackageId = packages["urn:altinn:accesspackage:posttjenester"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:innehaver"], PackageId = packages["urn:altinn:accesspackage:posttjenester"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:deltaker-fullt-ansvar"], PackageId = packages["urn:altinn:accesspackage:posttjenester"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:deltaker-delt-ansvar"], PackageId = packages["urn:altinn:accesspackage:posttjenester"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:komplementar"], PackageId = packages["urn:altinn:accesspackage:posttjenester"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:bestyrende-reder"], PackageId = packages["urn:altinn:accesspackage:posttjenester"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:bostyrer"], PackageId = packages["urn:altinn:accesspackage:posttjenester"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:role:hovedadministrator"], PackageId = packages["urn:altinn:accesspackage:posttjenester"], EntityVariantId = null, CanDelegate = true, HasAccess = false },

            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:daglig-leder"], PackageId = packages["urn:altinn:accesspackage:elektronisk-kommunikasjon"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:styreleder"], PackageId = packages["urn:altinn:accesspackage:elektronisk-kommunikasjon"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:innehaver"], PackageId = packages["urn:altinn:accesspackage:elektronisk-kommunikasjon"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:deltaker-fullt-ansvar"], PackageId = packages["urn:altinn:accesspackage:elektronisk-kommunikasjon"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:deltaker-delt-ansvar"], PackageId = packages["urn:altinn:accesspackage:elektronisk-kommunikasjon"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:komplementar"], PackageId = packages["urn:altinn:accesspackage:elektronisk-kommunikasjon"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:bestyrende-reder"], PackageId = packages["urn:altinn:accesspackage:elektronisk-kommunikasjon"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:bostyrer"], PackageId = packages["urn:altinn:accesspackage:elektronisk-kommunikasjon"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:role:hovedadministrator"], PackageId = packages["urn:altinn:accesspackage:elektronisk-kommunikasjon"], EntityVariantId = null, CanDelegate = true, HasAccess = false },
            ...
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:daglig-leder"], PackageId = packages["urn:altinn:accesspackage:starte-drive-endre-avvikle-virksomhet"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:styreleder"], PackageId = packages["urn:altinn:accesspackage:starte-drive-endre-avvikle-virksomhet"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:innehaver"], PackageId = packages["urn:altinn:accesspackage:starte-drive-endre-avvikle-virksomhet"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:deltaker-fullt-ansvar"], PackageId = packages["urn:altinn:accesspackage:starte-drive-endre-avvikle-virksomhet"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:deltaker-delt-ansvar"], PackageId = packages["urn:altinn:accesspackage:starte-drive-endre-avvikle-virksomhet"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:komplementar"], PackageId = packages["urn:altinn:accesspackage:starte-drive-endre-avvikle-virksomhet"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:bestyrende-reder"], PackageId = packages["urn:altinn:accesspackage:starte-drive-endre-avvikle-virksomhet"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:role:hovedadministrator"], PackageId = packages["urn:altinn:accesspackage:starte-drive-endre-avvikle-virksomhet"], EntityVariantId = null, CanDelegate = true, HasAccess = false },
            ...
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:daglig-leder"], PackageId = packages["urn:altinn:accesspackage:teknisk-samhandling-skatt"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:styreleder"], PackageId = packages["urn:altinn:accesspackage:teknisk-samhandling-skatt"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:innehaver"], PackageId = packages["urn:altinn:accesspackage:teknisk-samhandling-skatt"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:deltaker-fullt-ansvar"], PackageId = packages["urn:altinn:accesspackage:teknisk-samhandling-skatt"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:deltaker-delt-ansvar"], PackageId = packages["urn:altinn:accesspackage:teknisk-samhandling-skatt"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:komplementar"], PackageId = packages["urn:altinn:accesspackage:teknisk-samhandling-skatt"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:bestyrende-reder"], PackageId = packages["urn:altinn:accesspackage:teknisk-samhandling-skatt"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:bostyrer"], PackageId = packages["urn:altinn:accesspackage:teknisk-samhandling-skatt"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:role:hovedadministrator"], PackageId = packages["urn:altinn:accesspackage:teknisk-samhandling-skatt"], EntityVariantId = null, CanDelegate = true, HasAccess = false },

            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:daglig-leder"], PackageId = packages["urn:altinn:accesspackage:beredskap"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:styreleder"], PackageId = packages["urn:altinn:accesspackage:beredskap"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:innehaver"], PackageId = packages["urn:altinn:accesspackage:beredskap"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:deltaker-fullt-ansvar"], PackageId = packages["urn:altinn:accesspackage:beredskap"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:deltaker-delt-ansvar"], PackageId = packages["urn:altinn:accesspackage:beredskap"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:komplementar"], PackageId = packages["urn:altinn:accesspackage:beredskap"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:bestyrende-reder"], PackageId = packages["urn:altinn:accesspackage:beredskap"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:bostyrer"], PackageId = packages["urn:altinn:accesspackage:beredskap"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:role:hovedadministrator"], PackageId = packages["urn:altinn:accesspackage:beredskap"], EntityVariantId = null, CanDelegate = true, HasAccess = false },

            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:daglig-leder"], PackageId = packages["urn:altinn:accesspackage:offentlige-anskaffelser"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:styreleder"], PackageId = packages["urn:altinn:accesspackage:offentlige-anskaffelser"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:innehaver"], PackageId = packages["urn:altinn:accesspackage:offentlige-anskaffelser"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:deltaker-fullt-ansvar"], PackageId = packages["urn:altinn:accesspackage:offentlige-anskaffelser"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:deltaker-delt-ansvar"], PackageId = packages["urn:altinn:accesspackage:offentlige-anskaffelser"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:komplementar"], PackageId = packages["urn:altinn:accesspackage:offentlige-anskaffelser"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:bestyrende-reder"], PackageId = packages["urn:altinn:accesspackage:offentlige-anskaffelser"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:bostyrer"], PackageId = packages["urn:altinn:accesspackage:offentlige-anskaffelser"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
            new RolePackage() { RoleId = roles["urn:altinn:role:hovedadministrator"], PackageId = packages["urn:altinn:accesspackage:offentlige-anskaffelser"], EntityVariantId = null, CanDelegate = true, HasAccess = false },
            ...
            new RolePackage() { RoleId = roles["urn:altinn:external-role:ccr:bostyrer"], PackageId = packages["urn:altinn:accesspackage:sykefravaer-personopplysninger-saerlig-kategori"], EntityVariantId = null, CanDelegate = true, HasAccess = true },
        };
    ...
    private async Task Cleanup(ChangeRequestOptions options, CancellationToken cancellationToken = default)
    {
        ...
        {
            await CleanupAdminRoles(options, cancellationToken);
            await migrationService.LogMigration<Role>(dataKey, "Delete old admin roles urn:altinn:role:klientadministrator, urn:altinn:role:tilgangsstyrer, urn:altinn:role:maskinporten-administrator", 1);
        }
    }
    ...
    private async Task CleanupNufRolePackage(ChangeRequestOptions options, CancellationToken cancellationToken = default)
    {
        var filter = rolePackageRepository.CreateFilterBuilder();
        filter.Equal(t => t.RoleId, Guid.Parse("69c4397a-9e34-4e73-9f69-534bc1bb74c8")); // urn:altinn:external-role:ccr:kontaktperson-nuf
