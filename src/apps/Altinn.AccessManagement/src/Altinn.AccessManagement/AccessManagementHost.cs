...
internal static partial class AccessManagementHost
{
    ...
    private static void ConfigureAuthorization(this WebApplicationBuilder builder)
    {
        ...
        builder.Services.AddAuthorizationBuilder()
            ...
            .AddPolicy(AuthzConstants.ALTINN_SERVICEOWNER_DELEGATIONREQUESTS_READ, policy => policy.Requirements.Add(new ScopeAccessRequirement([AuthzConstants.SCOPE_PORTAL_SERVICEOWNER, AuthzConstants.ALTINN_SERVICEOWNER_DELEGATIONREQUESTS_READ])))
            .AddPolicy(AuthzConstants.ALTINN_SERVICEOWNER_DELEGATIONREQUESTS_WRITE, policy => policy.Requirements.Add(new ScopeAccessRequirement([AuthzConstants.SCOPE_PORTAL_SERVICEOWNER, AuthzConstants.ALTINN_SERVICEOWNER_DELEGATIONREQUESTS_WRITE])))
