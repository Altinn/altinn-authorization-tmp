...
internal static partial class AccessManagementHost
{
    ...
    private static void ConfigureAuthorization(this WebApplicationBuilder builder)
    {
        ...
        builder.Services.AddAuthorizationBuilder()
            ...
            .AddPolicy(AuthzConstants.POLICY_ENDUSER_CONNECTIONS_WRITE, policy => policy.AddRequirementConditionalScope(
                new(ConditionalScope.FromOthers, AuthzConstants.SCOPE_PORTAL_ENDUSER, AuthzConstants.SCOPE_ENDUSER_CONNECTIONS_FROMOTHERS_WRITE),
                new(ConditionalScope.ToOthers, AuthzConstants.SCOPE_PORTAL_ENDUSER, AuthzConstants.SCOPE_ENDUSER_CONNECTIONS_TOOTHERS_WRITE)
            ));
