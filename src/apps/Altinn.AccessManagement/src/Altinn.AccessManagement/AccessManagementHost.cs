...
internal static partial class AccessManagementHost
{
    ...
    private static void ConfigureAuthorization(this WebApplicationBuilder builder)
    {
        ...
        builder.Services.AddAuthorizationBuilder()
            ...
            .AddPolicy(AuthzConstants.POLICY_MASKINPORTEN_SUPPLIERS_ENDUSER_READ, policy => policy.Requirements.Add(new ScopeAccessRequirement([AuthzConstants.SCOPE_PORTAL_ENDUSER, AuthzConstants.SCOPE_ENDUSER_MASKINPORTENSUPPLIERS_READ])))
            .AddPolicy(AuthzConstants.POLICY_MASKINPORTEN_SUPPLIERS_ENDUSER_WRITE, policy => policy.Requirements.Add(new ScopeAccessRequirement([AuthzConstants.SCOPE_PORTAL_ENDUSER, AuthzConstants.SCOPE_ENDUSER_MASKINPORTENSUPPLIERS_WRITE])))
            .AddPolicy(AuthzConstants.POLICY_MASKINPORTEN_CONSUMERS_ENDUSER_READ, policy => policy.Requirements.Add(new ScopeAccessRequirement([AuthzConstants.SCOPE_PORTAL_ENDUSER, AuthzConstants.SCOPE_ENDUSER_MASKINPORTENCONSUMERS_READ])))
            .AddPolicy(AuthzConstants.POLICY_MASKINPORTEN_CONSUMERS_ENDUSER_WRITE, policy => policy.Requirements.Add(new ScopeAccessRequirement([AuthzConstants.SCOPE_PORTAL_ENDUSER, AuthzConstants.SCOPE_ENDUSER_MASKINPORTENCONSUMERS_WRITE])))
