...
namespace Altinn.AccessManagement.Api.Metadata.Controllers
{
    ...
    public class RolesController : ControllerBase
    {
        ...
        [Route("{key}/{value}")]
        [HttpGet]
        public async Task<ActionResult<RoleDto>> GetKeyPairValue(string key, string value)
        {
        ...
        [Route("exports")]
        [HttpGet]
        public async Task<ActionResult<RoleDto>> ExportRoles()
        {
            throw new NotImplementedException();
        }

        /// <summary>
        /// Exports rolepackagemap
        /// </summary>
        /// <returns>A <see cref="Task{TResult}"/> representing the result of the asynchronous operation.</returns>
        [Route("exportrolepackagemap")]
        [HttpGet]
        public async Task<ActionResult<RoleDto>> ExportRolePackageMap()
        {
            throw new NotImplementedException();
        }
    }
