...
public static class HttpClientExtension
{
    ...
    public static Task<HttpResponseMessage> PostAsync(this HttpClient httpClient, string authorizationToken, string requestUri, HttpContent content, string? platformAccessToken = null, CancellationToken cancellationToken = default)
    {
