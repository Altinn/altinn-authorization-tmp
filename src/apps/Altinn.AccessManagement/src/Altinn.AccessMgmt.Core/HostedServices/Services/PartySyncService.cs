...
// using Altinn.AccessMgmt.Core.Contracts;
...
//     IAltinnLease Lease,
//     IEntityTypeRepository _entityTypeRepository,
//     IEntityVariantRepository _entityVariantRepository,
//     IEntityLookupRepository _lookupRepository
// ) : base(lease, feat), BaseSyncService, IPartySyncService
// {
//     /// <summary>
...
//             {
//                 Log.ResponseError(Logger, page.StatusCode);
...
//             Logger.LogInformation("Starting proccessing party page '{0}'", batchName);
...
//                 try
//                 {
//                     Logger.LogInformation("Ingest and Merge Entity and EntityLookup batch '{0}' to db", batchName);
...
//                     {
//                         Logger.LogWarning("Ingest partial complete: Entity ({0}/{1}) EntityLookup ({2}/{3})", ingestedEntities, bulk.Count, ingestedLookups, bulkLookup.Count);
//                     }
...
//                     Logger.LogInformation("Merge complete: Entity ({0}/{1}) EntityLookup ({2}/{3})", mergedEntities, ingestedEntities, mergedLookups, ingestedLookups);
//                 }
//                 catch (Exception ex)
//                 {
//                     Logger.LogError(ex, "Failed to ingest and/or merge Entity and EntityLookup batch {0} to db", batchName);
