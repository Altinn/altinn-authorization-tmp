...
public class AgentRemovedClientNotificationHandler(AppDbContext db, IFeatureManager featureManager) : IOutboxHandler
{
...
public class AgentRemovedClientNotificationMessage
{
