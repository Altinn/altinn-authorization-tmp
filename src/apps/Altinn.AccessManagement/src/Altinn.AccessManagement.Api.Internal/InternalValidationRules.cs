...
public static class InternalValidationRules
{
    ...
    /// <summary>
    /// Validates the default query parameters.
    /// </summary>
    ...
    /// </returns>
    public static ValidationProblemInstance AddConnection(string party, string from, string to) => Validate(
        QueryParameters.Party(party),
        QueryParameters.PartyFrom(from),
        QueryParameters.PartyTo(to),
        QueryParameters.InternalAddCombination(party, from, to)
    );

    /// <summary>
    /// Validates the default query parameters for an.
    /// </summary>
    /// <param name="party">The UUID of the acting party (the user acting on behalf). Can also be "me".</param>
    /// <param name="from">The UUID of the 'from' party (could be a person or an organization).</param>
    /// <param name="to">The UUID of the 'to' party (could be a person or an organization).</param>
    ...
    /// A <see cref="ValidationProblemInstance"/> with validation errors if any.
    /// </returns>
    public static ValidationProblemInstance AddConnectionPackage(string party, string from, string to, Guid? packageId, string packageUrn) => Validate(
        QueryParameters.Party(party),
        QueryParameters.PartyFrom(from),
        QueryParameters.PartyTo(to),
    ...
    /// A <see cref="ValidationProblemInstance"/> with validation errors if any.
    /// </returns>
    public static ValidationProblemInstance ReadConnection(string party, string from, string to) => Validate(
        QueryParameters.Party(party),
        QueryParameters.InternalReadInputCombination(party, from, to),
        Any(
            QueryParameters.PartyFrom(from),
            QueryParameters.PartyTo(to)
        )
    ...
    /// A <see cref="ValidationProblemInstance"/> with validation errors if any.
    /// </returns>
    public static ValidationProblemInstance RemoveConnection(string party, string from, string to) => Validate(
        QueryParameters.Party(party),
        QueryParameters.PartyFrom(from),
        QueryParameters.PartyTo(to),
        QueryParameters.InternalRemoveCombination(party, from, to)
    );
    ...
    /// A <see cref="ValidationProblemInstance"/> with validation errors if any.
    /// </returns>
    public static ValidationProblemInstance RemoveConnectionPacakge(string party, string from, string to, Guid? packageId, string packageUrn) => Validate(
        QueryParameters.Party(party),
        QueryParameters.PartyFrom(from),
        QueryParameters.PartyTo(to),
        QueryParameters.PackageReference(packageId, packageUrn),
    ...
    public static class QueryParameters
    {
        ...
        /// </summary>
        internal static RuleExpression InternalAddCombination(string party, string from, string to) => () =>
        {
        ...
        /// </returns>
        internal static RuleExpression InternalReadInputCombination(string party, string from, string to) => () =>
        {
        ...
        /// <param name="to">The UUID of the 'to' party (could be a person or an organization).</param>
        /// <returns></returns>
        internal static RuleExpression InternalRemoveCombination(string party, string from, string to) => () =>
        {
            if (!Guid.TryParse(party, out var partyUuid))
            {
                return (ref ValidationErrorBuilder errors) =>
