...
public class SystemUserClientDelegationControllerTest
{
    ...
    [Fact]
    public async Task GetClients_InvalidRole_Returns400BadRequest()
    {
    ...
    [Fact]
    public async Task GetClients_ValidRoles_Returns200Ok()
    {
    ...
    [Fact]
    public async Task GetClients_NoRolesUsesDefaults_Returns200Ok()
    {
        var assignmentSvc = new Mock<IAssignmentService>();
        assignmentSvc.Setup(s => s.GetClients(Party, It.IsAny<string[]>(), It.IsAny<string[]>(), It.IsAny<CancellationToken>()))
                     .ReturnsAsync([]);
    ...
    [Fact]
    public async Task GetClientDelegations_Returns200Ok()
    {
    ...
    [Fact]
    public async Task PostClientDelegation_Returns200Ok()
    {
    ...
    [Fact]
    public async Task DeleteDelegation_NotFound_Returns400BadRequest()
    {
        var delegationSvc = new Mock<IDelegationService>();
    ...
    [Fact]
    public async Task DeleteDelegation_WrongFacilitator_Returns400BadRequest()
    {
    ...
    [Fact]
    public async Task DeleteDelegation_AssignmentToIdMismatch_Returns400BadRequest()
    {
    ...
    [Fact]
    public async Task DeleteAssignment_NotFound_Returns400BadRequest()
    {
        var assignmentSvc = new Mock<IAssignmentService>();
    ...
    [Fact]
    public async Task DeleteAssignment_WrongFromParty_Returns400BadRequest()
    {
        var assignment = new Assignment { FromId = Guid.NewGuid(), ToId = Guid.NewGuid() };
        var assignmentSvc = new Mock<IAssignmentService>();
        assignmentSvc.Setup(s => s.GetAssignment(AssignmentId, It.IsAny<CancellationToken>()))
