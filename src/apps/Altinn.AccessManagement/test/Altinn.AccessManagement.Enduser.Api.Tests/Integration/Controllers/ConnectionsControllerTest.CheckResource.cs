...
public partial class ConnectionsControllerTest
{
    ...
    public class CheckResource : IClassFixture<ApiFixture>
    {
        ...
        /// </summary>
        [Fact]
        public async Task CheckResource_NavSykemeldingDialog_FullAccess_RolesAndPackages_Returns200Ok()
        {
        ...
        /// </summary>
        [Fact]
        public async Task CheckResource_NavSykemeldingDialog_FullAccess_Packages_Returns200Ok()
        {
        ...
        /// </summary>
        [Fact]
        public async Task CheckResource_DiheOmsetningsoppgave_PartialAccess_RolesAndPackages_Returns200Ok()
        {
            HttpClient client = CreateClient(TestData.MalinEmilie.Id, AuthzConstants.SCOPE_ENDUSER_CONNECTIONS_TOOTHERS_WRITE);
        ...
        /// </summary>
        [Fact]
        public async Task CheckResource_WithReadScope_Returns403Forbidden()
        {
        ...
        /// </summary>
        [Fact]
        public async Task CheckResource_WithFromOthersWriteScope_Returns403Forbidden()
        {
