...
/// </remarks>
public class IdPortenAuthorizationApiFixture : RightsApiFixture
{
    /// <summary>
    /// Initializes a new instance of the <see cref="IdPortenAuthorizationApiFixture"/> class.
    /// </summary>
    public IdPortenAuthorizationApiFixture()
    {
        ConfigureServices(services =>
        {
            services.AddSingleton<IIdPortenAuthorizationClient, IdPortenAuthorizationClientMock>();
        });
    }
}
