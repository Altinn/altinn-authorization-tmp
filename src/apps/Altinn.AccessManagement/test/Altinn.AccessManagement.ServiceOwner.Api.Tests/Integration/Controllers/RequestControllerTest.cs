...
public class RequestControllerTest
{
    ...
    public class CreateResourceRequestTest : IClassFixture<ApiFixture>
    {
        ...
        [Fact]
        public async Task CreateRequest_WithInvalidFromUrn_Returns400BadRequest()
        {
            var client = CreateClient(Fixture, TestData.NAV.Entity.OrganizationIdentifier);
        ...
        [Fact]
        public async Task CreateRequest_WithInvalidResourceProvider_Returns400BadRequest()
        {
        ...
        [Fact]
        public async Task CreateRequest_WithEmptyResourceId_Returns400BadRequest()
        {
            var client = CreateClient(Fixture, TestData.NAV.Entity.OrganizationIdentifier);
            var from = $"urn:altinn:organization:identifier-no:{TestData.BakerJohnsen.Entity.OrganizationIdentifier}";
            var to = $"urn:altinn:person:identifier-no:{TestData.LarsBakke.Entity.PersonIdentifier}";
    ...
    public class CreatePackageRequestTest : IClassFixture<ApiFixture>
    {
        ...
        [Fact]
        public async Task CreateRequest_AndOtherSOWithdraw_Returns403Forbidden()
        {
            var client = CreateClient(Fixture, TestData.NAV.Entity.OrganizationIdentifier);
            var to = $"urn:altinn:organization:identifier-no:{TestData.BakerJohnsen.Entity.OrganizationIdentifier}";
            var from = $"urn:altinn:person:identifier-no:{TestData.LarsBakke.Entity.PersonIdentifier}";
        ...
        [Fact]
        public async Task CreateRequest_ApproveAndWithdraw_Returns400BadRequest()
        {
            var client = CreateClient(Fixture, TestData.NAV.Entity.OrganizationIdentifier);
            var to = $"urn:altinn:organization:identifier-no:{TestData.BakerJohnsen.Entity.OrganizationIdentifier}";
            var from = $"urn:altinn:person:identifier-no:{TestData.LarsBakke.Entity.PersonIdentifier}";
        ...
        [Fact]
        public async Task CreateRequest_WithEmptyPackageUrn_Returns400BadRequest()
        {
            var client = CreateClient(Fixture, TestData.NAV.Entity.OrganizationIdentifier);
            var to = $"urn:altinn:organization:identifier-no:{TestData.BakerJohnsen.Entity.OrganizationIdentifier}";
            var from = $"urn:altinn:person:identifier-no:{TestData.LarsBakke.Entity.PersonIdentifier}";
    ...
    public class GetRequestStatusTest : IClassFixture<ApiFixture>
    {
        ...
        [Fact]
        public async Task GetRequestStatus_ForUnknownId_Returns400BadRequest()
        {
        ...
        [Fact]
        public async Task GetRequestStatus_Unauthenticated_Returns401Unauthorized()
        {
    ...
    public class CreateResourceRequestByQueryTest : IClassFixture<ApiFixture>
    {
        ...
        [Fact]
        public async Task CreateResourceRequest_WithInvalidFromUrn_Returns400BadRequest()
        {
            var client = CreateClient(Fixture, TestData.NAV.Entity.OrganizationIdentifier);
    ...
    public class CreatePackageRequestByQueryTest : IClassFixture<ApiFixture>
    {
        ...
        [Fact]
        public async Task CreatePackageRequest_WithInvalidFromUrn_Returns400BadRequest()
        {
            var client = CreateClient(Fixture, TestData.NAV.Entity.OrganizationIdentifier);
            var from = "urn:invalid:prefix:12345";
            var to = $"urn:altinn:person:identifier-no:{TestData.LarsBakke.Entity.PersonIdentifier}";
        ...
        [Fact]
        public async Task CreatePackageRequest_WithInvalidFromType_Returns400BadRequest()
        {
            var client = CreateClient(Fixture, TestData.NAV.Entity.OrganizationIdentifier);
            var from = $"urn:altinn:person:identifier-no:{TestData.LarsBakke.Entity.PersonIdentifier}";
            var to = $"urn:altinn:organization:identifier-no:{TestData.BakerJohnsen.Entity.OrganizationIdentifier}";
