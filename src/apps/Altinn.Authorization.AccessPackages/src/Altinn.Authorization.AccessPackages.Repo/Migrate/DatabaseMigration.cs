...
public class DatabaseMigration : IDatabaseMigration
{
    ...
    private async Task CreateAssignment()
    {
        ...
        await _factory.CreateForeignKeyConstraint<Assignment, Role>(t => t.RoleId);
        await _factory.CreateForeignKeyConstraint<Assignment, Entity>(t => t.FromId);
        await _factory.CreateForeignKeyConstraint<Assignment, Entity>(t => t.ToId);
    ...
    private async Task CreateGroups()
    {
        ...
        await _factory.CreateForeignKeyConstraint<Group, Entity>(t => t.OwnerId);
        ...
        await _factory.CreateForeignKeyConstraint<GroupMember, Group>(t => t.GroupId);
        await _factory.CreateForeignKeyConstraint<GroupMember, Entity>(t => t.MemberId);
        ...
        await _factory.CreateForeignKeyConstraint<GroupAdmin, Group>(t => t.GroupId);
        await _factory.CreateForeignKeyConstraint<GroupAdmin, Entity>(t => t.MemberId);
    ...
    private async Task CreateDelegations()
    {
        ...
        await _factory.CreateForeignKeyConstraint<GroupDelegation, Assignment>(t => t.AssignmentId);
        await _factory.CreateForeignKeyConstraint<GroupDelegation, Group>(t => t.GroupId);
        ...
        await _factory.CreateForeignKeyConstraint<RoleDelegation, Assignment>(t => t.AssignmentId);
        await _factory.CreateForeignKeyConstraint<RoleDelegation, Role>(t => t.RoleId);
        ...
        await _factory.CreateForeignKeyConstraint<AssignmentDelegation, Assignment>(t => t.FromAssignmentId);
        await _factory.CreateForeignKeyConstraint<AssignmentDelegation, Assignment>(t => t.ToAssignmentId);
        ...
        await _factory.CreateForeignKeyConstraint<EntityDelegation, Assignment>(t => t.AssignmentId);
        await _factory.CreateForeignKeyConstraint<EntityDelegation, Role>(t => t.EntityId);
    ...
    private async Task CreateEntity()
    {
        ...
        await _factory.CreateForeignKeyConstraint<EntityType, Provider>(t => t.ProviderId);
        ...
        await _factory.CreateForeignKeyConstraint<EntityVariant, EntityType>(t => t.TypeId);
        ...
        await _factory.CreateForeignKeyConstraint<Entity, EntityType>(t => t.TypeId);
        await _factory.CreateForeignKeyConstraint<Entity, EntityVariant>(t => t.VariantId);
    ...
    private async Task CreateArea()
    {
        ...
        await _factory.CreateForeignKeyConstraint<Area, AreaGroup>(t => t.GroupId);
    ...
    private async Task CreatePackage()
    {
        ...
        await _factory.CreateForeignKeyConstraint<Package, Provider>(t => t.ProviderId);
        await _factory.CreateForeignKeyConstraint<Package, EntityType>(t => t.EntityTypeId);
        await _factory.CreateForeignKeyConstraint<Package, Area>(t => t.AreaId);
        ...
        await _factory.CreateForeignKeyConstraint<PackageTag, Package>(t => t.PackageId);
        await _factory.CreateForeignKeyConstraint<PackageTag, Tag>(t => t.TagId);
        ...
        await _factory.CreateForeignKeyConstraint<PackageDelegation, Package>(t => t.PackageId);
        await _factory.CreateForeignKeyConstraint<PackageDelegation, Entity>(t => t.ForId);
        await _factory.CreateForeignKeyConstraint<PackageDelegation, Entity>(t => t.ToId);
        await _factory.CreateForeignKeyConstraint<PackageDelegation, Entity>(t => t.ById);
    ...
    private async Task CreateRole()
    {
        ...
        await _factory.CreateForeignKeyConstraint<Role, EntityType>(t => t.EntityTypeId);
        await _factory.CreateForeignKeyConstraint<Role, Provider>(t => t.ProviderId);
        ...
        await _factory.CreateForeignKeyConstraint<RolePackage, EntityVariant>(t => t.EntityVariantId);
        ...
        await _factory.CreateForeignKeyConstraint<EntityVariantRole, EntityVariant>(t => t.VariantId);
        ...
        await _factory.CreateForeignKeyConstraint<RoleMap, Role>(t => t.HasRoleId);
        await _factory.CreateForeignKeyConstraint<RoleMap, Role>(t => t.GetRoleId);
    ...
    private async Task CreateResource()
    {
        ...
        await _factory.CreateForeignKeyConstraint<ResourceGroup, Provider>(t => t.ProviderId);
        ...
        */
        ...
        await _factory.CreateForeignKeyConstraint<Resource, Provider>(t => t.ProviderId);
        await _factory.CreateForeignKeyConstraint<Resource, ResourceType>(t => t.TypeId);
        await _factory.CreateForeignKeyConstraint<Resource, ResourceGroup>(t => t.GroupId);
        ...
        */
        ...
        await _factory.CreateForeignKeyConstraint<PackageResource, Package>(t => t.PackageId);
        await _factory.CreateForeignKeyConstraint<PackageResource, Resource>(t => t.ResourceId);
    }
}
